...
public class DocXAPI { 
    ...
    class MergeFields {
        ...
        Map<String, TextField> textVariables = new HashMap<>();                  //1st String = name of merge field
        Map<String, ImageField> imageVariables = new HashMap<>() ;
        Map<String, List<Map<String, String>>> tables = new HashMap<>();     //1st String = name of table
        String keySeed = "" ;
